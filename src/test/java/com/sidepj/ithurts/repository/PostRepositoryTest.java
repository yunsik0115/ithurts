...
class PostRepositoryTest {
    ...
    void findAllByMemberName() {
        PageRequest pageRequest = PageRequest.of(0, 5);
        Page<Post> searchedPageWithSameName = postRepository.findPostsByName("Yunsik", pageRequest);
        Page<Post> searchedPageWithNotSameName = postRepository.findPostsByName("yun", pageRequest);
        Assertions.assertThat(searchedPageWithSameName.getTotalElements()).isEqualTo(10);
        Assertions.assertThat(searchedPageWithNotSameName.getTotalElements()).isEqualTo(0);
    }
