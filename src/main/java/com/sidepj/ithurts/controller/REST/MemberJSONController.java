...
public class MemberJSONController {
    ...
    public ResponseEntity<LoveJsonResponse> getLovesByMember(@PathVariable Long memberId){
    ...
    public ResponseEntity<CommentJsonResponse> getCommentsByMember(@PathVariable Long memberId){
